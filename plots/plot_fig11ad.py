...
cmap_tem=plt.get_cmap('RdBu_r',22)
...
if ltemp:
    pcol_tem  = ax[0].pcolormesh(lon2d,lat2d,temp2dm,vmin=-2   ,vmax=3.5,cmap=cmap_tem,transform=ccrs.PlateCarree(),rasterized=True) #vmax=2
...
ax[1].gridlines()
if lisf:
    ax[1].pcolormesh(lon2d,lat2d,var2dm ,vmin=-6.5 ,vmax=30 ,cmap=cmap    ,transform=ccrs.PlateCarree(),rasterized=True) #vmax=5 vmin=-1.1
if ltemp:
    ax[1].pcolormesh(lon2d,lat2d,temp2dm,vmin=-2   ,vmax=3.5 ,cmap=cmap_tem,transform=ccrs.PlateCarree(),rasterized=True) #vmax=2 vmin
...
ax[2].gridlines()
if lisf:
    ax[2].pcolormesh(lon2d,lat2d,var2dm ,vmin=-6.5 ,vmax=30 ,cmap=cmap    ,transform=ccrs.PlateCarree(),rasterized=True)
if ltemp:
    ax[2].pcolormesh(lon2d,lat2d,temp2dm,vmin=-2   ,vmax=3.5 ,cmap=cmap_tem,transform=ccrs.PlateCarree(),rasterized=True)
...
ax[3].gridlines()
if lisf:
    pcol_lmlt = ax[3].pcolormesh(lon2d,lat2d,var2dm ,vmin=-6.5 ,vmax=30 ,cmap=cmap    ,transform=ccrs.PlateCarree(),rasterized=True)
if ltemp:
    pcol_tem  = ax[3].pcolormesh(lon2d,lat2d,temp2dm,vmin=-2   ,vmax=3.5 ,cmap=cmap_tem,transform=ccrs.PlateCarree(),rasterized=True)
